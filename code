// ==UserScript==
// @name         YouTube-Livechat-Channel-Resolver translated into german
...
var main = function() {
    ...
    var appendAdditionalChannelContextItems = function(reqUrl, response) {
        ...
        mainMenuRendererNode.menuRenderer.items.push(generateMenuLinkItem("/channel/" + mappedChannel.channelId, "Zum Kanal", "ACCOUNT_BOX"));

        // append social blade statistic shortcut
        mainMenuRendererNode.menuRenderer.items.push(generateMenuLinkItem("https://socialblade.com/youtube/channel/" + mappedChannel.channelId, "Socialblade Statistik", "MONETIZATION_ON"));
